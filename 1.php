        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
         ...
         <?php for ($i = 0; $i < count($jobs); $i++) :?>
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$i]['start']; ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $jobs[$i]['end']; ?></span></h6>
